...
import com.gcstudio.world.Node;
...
public class Entity {
	...
	public static BufferedImage GUN_DAMAGE_LEFT = Game.spritesheet.getSprite(0, 32, 16, 16);
	protected double x;
	protected double y;
	protected int width;
	...
	public void followPath(List<Node> path) {
		if(path != null) {
			if(path.size() > 0) {
				...
				else if(y > target.x * 16 && !isColidding(this.getX()-1, this.getY())) {
					x--;
				}
